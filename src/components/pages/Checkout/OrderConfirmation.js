									...
									<div className="col col-lg-6 col-md-6 col-sm-12 col-12 p-3">
										...
										<div className="row pt-3">
											<div className="col col-lg-6 col-md-6 col-sm-6 col-6">
												...
												<strong>Paypal Payment Status: </strong>
											</div>
											<div className="col col-lg-6 col-md-6 col-sm-6 col-6">
												Paypal<br/>
												{this.state.payer.email}<br/>
												{this.state.payer.status}<br/>
											</div>
										</div>
									</div>
									<div className="col col-lg-6 col-md-6 col-sm-12 col-12 p-3">
										...
										<div className="row pt-3">
											...
											<div className="col col-lg-6 col-md-6 col-sm-6 col-6">
												£{this.state.orders.subtotal}<br/>
												£{this.state.orders.shippingcharges}<br/>
												£{this.state.orders.ordertotal}<br/>
											</div>
										</div>
									</div>
							      </div>
